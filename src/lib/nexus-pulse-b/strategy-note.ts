...
**Live paper** uses the **same bar rules as the study**: today’s session candles only, **first 40×1m warm-up**, one action per 3m timestamp, **strict ATM**, Lane B default, and **entry/exit marks from closed option 1m closes only** (live LTP only for forced SQ / 15:00 flat).
