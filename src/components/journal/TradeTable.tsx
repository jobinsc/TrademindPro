...
import { calcPnL, isOpenTrade, type Trade } from '@/lib/trades';
          ...
          <tbody>
            {trades.map((trade) => {
              ...
              return (
                ...
                >
                  <td className="px-4 py-3 text-sky-ink/70">
                    <p>{trade.tradeDate}</p>
                    {!open && trade.exitDate && (
                  ...
                  <td className="px-4 py-3">
                    <p className="font-semibold text-sky-ink">{trade.symbol}</p>
                  ...
                  <td className="px-4 py-3 tabular-nums text-sky-ink/80">{trade.qty}</td>
                  ...
                  <td className="px-4 py-3 text-sky-ink/65">{trade.strategy}</td>
                  <td className="px-4 py-3">
