...
const ALL_FIELDS: ScanSettingsField[] = [
  ...
  { key: 'emaFast', label: 'Fast MA period', hint: 'Default 9 — change to 12, 20, etc.', step: 1 },
  { key: 'emaSlow', label: 'Slow MA period', hint: 'Default 21 — change to 50, 200, etc.', step: 1 },
