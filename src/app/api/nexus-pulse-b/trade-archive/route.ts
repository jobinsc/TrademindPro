...
import {
  listNexusBArchiveDates as listArchiveDates,
  loadNexusBArchiveDay as loadArchiveDay,
  type NexusBTradeMode as NexusTradeMode,
...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    dates,
    paths: {
      paper: '.data/nexus-pulse-b/trades/paper/YYYY-MM-DD.json',
      live: '.data/nexus-pulse-b/trades/live/YYYY-MM-DD.json',
    },
  });
}
